...
_Note: Chrome appears to not allow pasting the `javascript:` prefix in the URL so you may have to write it manually. Simply write `javascript:` and then paste the content you copied._
